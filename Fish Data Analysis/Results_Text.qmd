...
nnd_lmer_still <- lm(NND ~ Ablation*Species + Trial, data = school_data)
pwrss.f.reg(r2 = summary(nnd_lmer_still)$adj.r.squared, k = 3, power = 0.80, alpha = 0.05)

polar_lmer_still <- lm(School_Polar ~ Ablation*Species + Trial, data = school_data)
pwrss.f.reg(r2 = summary(polar_lmer_still)$adj.r.squared, k = 3, power = 0.80, alpha = 0.05)

speed_lmer_still <- lm(School_Speed ~ Ablation*Species + Trial, data = school_data)
pwrss.f.reg(r2 = summary(speed_lmer_still)$adj.r.squared, k = 3, power = 0.80, alpha = 0.05)
